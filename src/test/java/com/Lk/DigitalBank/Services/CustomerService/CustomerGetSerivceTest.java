...
public class CustomerGetSerivceTest {
    ...
    public void deveRetornarListaDeClientes(){
        ...
        CustomerGetDTO customerGetDTO = new CustomerGetDTO(1L, "Joaquim", LocalDate.of(2002, 2, 19), List.of());

        when(customerRepository.findAll()).thenReturn(list);
        when(conversor.converterCustomer(customer)).thenReturn(customerGetDTO);

        List<CustomerGetDTO> lista = customerGetService.listCustomer();
    ...
    @Test
    public void deveRetornarListaVaziaSeNaoTiverClientesCadastrados(){
        when(customerRepository.findAll()).thenReturn(List.of());

        List<CustomerGetDTO> list = customerGetService.listCustomer();
    ...
    public void deveRetornarClienteComCpfIgualDaBusca(){
        ...
        CustomerGetDTO customerGetDTO = new CustomerGetDTO(1L, "Joaquim", LocalDate.of(2004, 3, 12), List.of());
